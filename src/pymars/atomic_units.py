...
class UnitSystem:
    ...
    # Type hints for dynamically created attributes (to help type checkers)
    ANG: float
    ANGSTROM: float
    KCALPERMOL: float
    KJPERMOL: float
    ...
    def base_us2au_converter(self, **powers: Union[int, float]):
        """
    ...
    def base_au2us_converter(self, **powers: Union[int, float]):
        """
